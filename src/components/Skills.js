      ...
      <div className="container px-5 py-10 mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-base leading-relaxed xl:w-3/4 lg:w-3/4 mx-auto">
            ...
            <br />I confronted the problems of being a non-tech graduate,
            struggled through the challanges and developed following skills and
            is now continuously striving to add more to the list.
          </p>
        </div>
